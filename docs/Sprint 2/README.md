...
| --- | --- | --- | --- |
| CRM-11 | [Modelo Contacto/Empresa (EC)](11%20-%20Modelo%20Contacto-Empresa%20(EC).md) | Zaith Manangón | Completo (3/3 criterios; migración pendiente en `development` y producción) |
...
- Aplicar la migración `20260924120000_contact_company_ec` en `development` (`pnpm db:migrate:deploy`) y volver a sembrar (`pnpm db:seed`) para corregir la cédula y el RUC de ejemplo. Producción la recibe en el próximo despliegue de Render.
